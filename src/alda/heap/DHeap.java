...
public class DHeap<AnyType extends Comparable<? super AnyType>> {
	...
	public void insert(AnyType x) {
		...
		while (hole != 0 && x.compareTo(array[parentIndex(hole)]) < 0) {
...
//		}
	...
	/** 
	 * get the value at internal array index, fakes 1 based indexing
	 * @param index
	 * 				the index of value to return
	 * @return
	 * 				the value at specified index, null if empty
	 */
	AnyType get(int index) { 
		return index > 0 ? array[index-1] : null; // Pretend to use 1 based indexing
	}
